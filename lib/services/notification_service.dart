...
class NotificationService {
  ...
  static Future<void> sendTestNotification() async {
    try {
      ...
      // 2. Supabase'e kaydet
      await _saveTestNotificationToDatabase();
  ...
  static Future<void> _saveTestNotificationToDatabase() async {
    try {
      final user = _supabase.auth.currentUser;
      if (user == null) {
      ...
      final notification = NotificationModel(
        ...
        body: 'Chizo notification system is working!',
        data: {'test': true},
        isRead: false,
        createdAt: DateTime.now(),
      );
      ...
      print('❌ Failed to save test notification to database: $e');
    }
  }
